...
if do_processing == 1
    ...
    save([folder 'present_data_subset_freq'], 'freq','T','N','cycles','leg_labels','mean_freq_phase','ADC_FACTOR','mean_raw_data','mean_freq_mag','mean_freq_mags');
else
    load([folder 'present_data_subset_freq']);
end
...
if do_part1 == 1
    ...
    print -dtiff -r200 chap5images/waveform_v_freq_16x10
    ...
    %print -dtiff -r200 correlation_v_freq
...
print -dtiff -r200 chap4images/harmonic_amplitudes
...
print -dtiff -r200 chap4images/phase_error_v_N
...
PrettifyFigure(21,11,1,0); semilogy(freq,1000*rms_error,'-o','linewidth',2);
...
%print -dtiff -r200 rms_phase_error_v_N
