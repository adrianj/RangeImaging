...
set outputFileName "ddr2_deva_phy_autodetectedpins.tcl"
...
set ddr2_deva_phy_use_high_performance_timing 1
if {[namespace which -variable ::override_ddr2_deva_phy_use_high_performance_timing] != ""} {
  set ddr2_deva_phy_use_high_performance_timing $::override_ddr2_deva_phy_use_high_performance_timing
}
