...
ARCHITECTURE SYN OF ddr2_devb IS
	...
	COMPONENT ddr2_devb_controller_phy
	PORT (
		local_address	: IN STD_LOGIC_VECTOR (22 DOWNTO 0);
		local_write_req	: IN STD_LOGIC;
		local_read_req	: IN STD_LOGIC;
...
BEGIN
	...
	ddr2_devb_controller_phy_inst : ddr2_devb_controller_phy
	PORT MAP (
...
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="ddr2_devb_controller_phy" >
...
-- Retrieval info:      <PRIVATE name = "alt_top" value="ddr2_devb_auk_ddr_hp_controller_wrapper"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_excludes" value="ddr2_devb_phy_alt_mem_phy_sequencer_wrapper.v,alt_mem_phy_sequencer.vhd,ddr2_devb_phy_alt_mem_phy_dss_wrapper.v,alt_mem_phy_dss.vhd,ddr2_devb_phy.vhd,ddr2_devb_phy_alt_mem_phy_siii.v,alt_mem_phy_defines.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_includes" value="ddr2_devb_phy_alt_mem_phy_delay.vhd,ddr2_devb_phy.vho,ddr2_devb_phy_alt_mem_phy_sequencer_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "family" value="Stratix III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "filename" value="ddr2_devb_auk_ddr_hp_controller_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen2">
-- Retrieval info:      <PRIVATE name = "family" value="Stratix III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr2_devb_phy_alt_mem_phy_delay;+ddr2_devb_alt_mem_phy_sequencer_wrapper;+ddr2_devb_alt_mem_phy_reconfig_siii;+ddr2_devb_alt_mem_phy_pll_siii --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=D:\sync\PhD\RangeImaging\Altera\PMD19k_Stratix3/ddr2_devb_simgen_init.txt"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "filename" value="ddr2_devb_gb.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
