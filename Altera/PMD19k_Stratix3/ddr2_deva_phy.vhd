...
-- ============================================================
-- Megafunction Name(s):
-- 			ddr2_deva_phy_alt_mem_phy_siii
-- ============================================================
...
BEGIN
	...
	ddr2_deva_phy_alt_mem_phy_siii_inst : ddr2_deva_phy_alt_mem_phy_siii
	GENERIC MAP (
		ADDR_CMD_2T_EN => 1,
...
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="ddr2_deva_phy_alt_mem_phy_siii" >
...
-- Retrieval info:      <PRIVATE name = "alt_top" value="ddr2_deva_phy_alt_mem_phy_sequencer_wrapper"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_includes" value="ddr2_deva_phy_alt_mem_phy_delay.vhd"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "family" value="Stratix III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "filename" value="ddr2_deva_phy_alt_mem_phy_sequencer_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen2">
-- Retrieval info:      <PRIVATE name = "family" value="Stratix III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr2_deva_phy_alt_mem_phy_delay;+ddr2_deva_phy_alt_mem_phy_sequencer_wrapper;+ddr2_deva_phy_alt_mem_phy_reconfig_siii;+ddr2_deva_phy_alt_mem_phy_pll_siii --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=D:\sync\PhD\RangeImaging\Altera\PMD19k_Stratix3/ddr2_deva_phy_simgen_init.txt"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "filename" value="ddr2_deva_phy.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "filename" value="ddr2_deva_phy_gb.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
